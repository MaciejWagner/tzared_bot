...
$destDir = "C:\Users\maciek\ai_experiments\tzar_bot\demo_results\dom_test"
New-Item -ItemType Directory -Path $destDir -Force | Out-Null

$files = Invoke-Command -Session $session -ScriptBlock {
    Get-ChildItem "C:\TzarBot\Screenshots\dom_*.png" | Select-Object -ExpandProperty FullName
}
